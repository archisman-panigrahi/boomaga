...
{
    out.append(QString("/%1 <FEFF").arg(key).toLatin1());
...
#endif
        out.append(QString("%1%2").arg(b1, 2, 16, QChar('0')).arg(b2, 2, 16, QChar('0')).toLatin1());
    }
    out.append(">\n");
}
